...
class Review_annotated(BaseModel):
    ...
    name : Optional[list[str]]= Field(default=None, description="Write down the name of reviewer")



# Step3 : Invoke Model laden with  Pydantic class for annotated reviews
strcutured_model = model_openapi.with_structured_output(Review_annotated)
